...
def getpopu(filename,month,year):
  Y='平成'+str(year)+'年度'
...
if __name__=='__main__':
  ...
  colu=["日本人","外国人","総人口","日本人男性","日本人女性","外国人男性","外国人女性","基本世帯数","外国人世帯数","総世帯数"]
  ...
  popudata = pd.DataFrame([year25,year26,year27,year28,year29,year30,year31],columns=colu)
  
  popudata["年度"]=["25年度","26年度","27年度","28年度","29年度","30年度","31年度"]
  popudata = popudata.set_index("年度")
  print(popudata)
